    ...
    return (
        <>
            ...
            <div className='my-service-body'>
                ...
                {data && data.map((data =>
                    <div className="my-app-review-content">
                        <div className="reviewlist-content-each">
                            <div className="reviewlist-icon">
                                <img className='reviewlist-thumbnail' src={`http://${process.env.REACT_APP_IP}:${process.env.REACT_APP_PORT}/api/getimage/thumbnail/${data.thumbnailImage}`} />
                                <p>{data.imageName}</p>
                            </div>
